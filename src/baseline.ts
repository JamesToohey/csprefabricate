...
export const BASELINE_STRICT_CSP: ContentSecurityPolicy = {
 ...
 */
export const GOOGLE_ANALYTICS_CSP: ContentSecurityPolicy = {
    ...BASELINE_STRICT_CSP,
    [Directive.DEFAULT_SRC]: ["'self'"],
...
export const GOOGLE_ANALYTICS_WITH_SIGNALS_CSP: ContentSecurityPolicy = {
    ...BASELINE_STRICT_CSP,
